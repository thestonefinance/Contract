...
contract Sshare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SSHARE", "SSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 STONE Share for initial pools deployment
