...
contract TaxOfficeV2 is Operator {
    ...
    address public stone = address(0x4D7F7Fd518dC81bF60eadE7A677892F2Af912798);
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtStone, resultAmtToken, liquidity) = IUniswapV2Router(uniRouter).addLiquidity(
            stone,
            token,
            amtStone,
            amtToken,
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtStone, resultAmtFtm, liquidity) = IUniswapV2Router(uniRouter).addLiquidityETH{value: msg.value}(
            stone,
            amtStone,
            amtStoneMin,
            amtFtmMin,
